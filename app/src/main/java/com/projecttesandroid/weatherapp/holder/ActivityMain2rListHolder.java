...
public class ActivityMain2rListHolder extends RecyclerView.ViewHolder {
    ...
    public ActivityMain2rListHolder(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    @SuppressLint("SetTextI18n")
    public void updateUI(Activitymain2List weatherList) {
