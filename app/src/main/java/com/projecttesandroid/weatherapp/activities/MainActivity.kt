...
import com.projecttesandroid.weatherapp.adapter.MainAdapter
import com.projecttesandroid.weatherapp.fragment.FragmentNextDays
import com.projecttesandroid.weatherapp.model.ModelMain
import com.projecttesandroid.weatherapp.networking.ApiEndpoint
...
class MainActivity : AppCompatActivity(), LocationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button1 = findViewById(R.id.tvlokasi) as TextView
        button1?.setOnClickListener {
            val intentBiasa = Intent(this@MainActivity, HomeActivity::class.java)
